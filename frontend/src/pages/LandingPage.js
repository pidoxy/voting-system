...
const LandingPage = (props) => {
  ...
  // props
  const { connectWallet, currentAccount, networkId } = props;
      ...
      <div className="basis-1/2 text-center ">
        <div className="bg-white py-10 px-5 rounded-md">
          ...
          <button
            ...
            disabled={isMetaMaskInstalled && currentAccount ? true : false}
            className="bg-blue-500 hover:bg-blue-700 disabled:opacity-50 text-white font-bold py-2 px-4 my-5 rounded"
          >
            {isMetaMaskInstalled
